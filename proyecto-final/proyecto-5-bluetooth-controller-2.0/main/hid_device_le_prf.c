...
// Gamepad report descriptor - Solo gamepad, sin keyboard ni consumer control
static const uint8_t hidReportMap[] = {
    ...
    0x29, 0x10,  //   Usage Maximum (Button 16) - A, B, X, Y, L1, R1, L2, R2, unused, unused, SELECT, START, etc.
    0x15, 0x00,  //   Logical Minimum (0)
    0x25, 0x01,  //   Logical Maximum (1)
    0x75, 0x01,  //   Report Size (1)
    0x95, 0x10,  //   Report Count (16) - 16 botones (2 bytes completos)
